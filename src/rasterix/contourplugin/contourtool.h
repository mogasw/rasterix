...
**
****************************************************************************/
#ifndef CONTOURTOOL_H
#define CONTOURTOOL_H
...
/*!
 * \brief The ContourTool class
 */
class ContourTool : public Rasterix::Tool
{
    Q_OBJECT
    Q_PLUGIN_METADATA(IID "org.mogasw.Qt.Rasterix.Contour" FILE "contourplugin.json")
    Q_INTERFACES(Rasterix::Tool)

public:
    ContourTool(QObject *parent = 0);
    virtual ~ContourTool() {}
...
protected:
    ContourWorker* _worker;
    ContourWidget* _widget;
    QAction* _action;
};
